...
A = re.compile("[a-z][A-Z]{3}[a-z]{1}[A-Z]{3}[a-z]")
bodyGuard = re.compile("[A-Z]{3}[a-z]{1}[A-Z]{3}")
lowCase = re.compile("[a-z]{1}")

res = A.findall(a)
res = bodyGuard.findall("".join(res))

for i in res :
    tmp = lowCase.findall(i)
    print(*tmp, end="")
